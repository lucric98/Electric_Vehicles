...
## MODELLO 15: BUONO 0.875
gam_CONSUMPTION15 <- gam(CONSUMPTION ~ s(HEIGHT, bs="cr") + s(LENGTH, bs="cr") + s(I(HEIGHT*LENGTH),bs="cr"), data=scaled_data)
summary(gam_CONSUMPTION15)
...
gam_CONSUMPTION16 <- gam(CONSUMPTION ~ s(HEIGHT, bs="cr") + s(POWER, bs="cr") + s(I(HEIGHT*POWER),bs="cr"), data=scaled_data)
summary(gam_CONSUMPTION16)
...
##### RAGGIUNGIAMO 0.9 ANCHE CON HEIGHT, LENGTH, POWER + INTERAZIONE (0.875 TOGLIENDO POWER)